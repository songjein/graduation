...
${'site_srl205_argument'} = new ConditionArgument('site_srl', $args->site_srl, 'equal');
${'site_srl205_argument'}->checkNotNull();
${'site_srl205_argument'}->createConditionValue();
if(!${'site_srl205_argument'}->isValid()) return ${'site_srl205_argument'}->getErrorMessage();
if(${'site_srl205_argument'} !== null) ${'site_srl205_argument'}->setColumnType('number');
...
new ConditionGroup(array(
new ConditionWithArgument('`sites`.`site_srl`',$site_srl205_argument,"equal")))
));
