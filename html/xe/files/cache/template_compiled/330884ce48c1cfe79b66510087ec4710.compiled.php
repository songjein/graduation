...
<div class="container">
	...
	<header class="header">
		<h1>
			<a href="http://abs1111.dothome.co.kr/xe/Free" id="siteTitle">
				<?php if(!Context::getSiteTitle() && !$__Context->layout_info->LOGO_IMG && !$__Context->layout_info->LOGO_TEXT){ ?><img src="/xe/layouts/default/siteTitle.png" alt="XpressEngine"><?php } ?>
...
if($__Context->layout_info->LAYOUT_TYPE=='SUB_PAGE'){ ?> class="visual sub"<?php } ?>>
		<div class="list">
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="http://my-port4lio.appspot.com/login" class="item i1">
				<img src="/xe/layouts/default/visual.main.1.jpg" alt="" />
						</a><?php } ?>
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="http://my-port4lio.appspot.com/login" class="item i2">
				<img src="/xe/layouts/default/visual.main.2.jpg" alt="" />
							</a><?php } ?>
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="http://my-port4lio.appspot.com/login" class="item i3">
				<img src="/xe/layouts/default/visual.main.3.jpg" alt="" />
							</a><?php } ?>
			<?php if($__Context->layout_info->LAYOUT_TYPE=='SUB_PAGE'){ ?><a href="http://my-port4lio.appspot.com/login" class="item i1">
				<img src="/xe/layouts/default/visual.sub.jpg" alt="" />
...
<footer class="footer">
	<?php if(!$__Context->layout_info->FOOTER){ ?><p>Powered by <a href="http://xpressengine.com/">강상문 송제인 서영숙</a>.</p><?php } ?>
