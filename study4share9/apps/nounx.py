...
dic_path = '%s/dic.txt' % os.path.dirname(full_path)
postfix_path = '%s/postfix.txt' % os.path.dirname(full_path)

class NounX:
    def __init__(self, dic_path=dic_path, postfix_path=postfix_path):
        self._dic         = None
